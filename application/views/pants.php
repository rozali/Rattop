...
<html>
<head>
<title>Rattop Bastard| Short/Long Pants :: w3layouts</title>
		 ...
		 <div class="mountain-sec">
		   <h2>PANTS</h2>
		 	...
		 	<div class="bike">				 
				...
				<div class="fast-viw">
					<form role="form" action="<?php echo base_URL(); ?>index.php/welcome/detail" method="post" id="view<?php echo $row->idpants; ?>">
                    <?php echo form_hidden('id', $row->idpants); ?>
                    <?php echo form_hidden('type','pants'); ?>
                	</form>
                    <button type="submit" form="view<?php echo $row->idpants; ?>" data-html="true">Quick View</button>
				</div>
			</div>
			<?php 
			$counter++;
