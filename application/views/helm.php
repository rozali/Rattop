...
<html>
<head>
<title>Rattop Bastard| Helm :: w3layouts</title>
	   ...
	   <div class="singlespeed-sec">
		 ...
		 <div class="bike">				 
		     ...
		     <div class="bike-cost">
				 ...
				 <div class="fast-viw">
						<form role="form" action="<?php echo base_URL(); ?>index.php/welcome/detail" method="post" id="view<?php echo $row->idhelm; ?>">
                        <?php echo form_hidden('id', $row->idhelm); ?>
                        <?php echo form_hidden('type','helm'); ?>
                        </form>
                        <button type="submit" form="view<?php echo $row->idhelm; ?>" data-html="true">Quick View</button>
				 </div>
			</div>
			<?php 
			$counter++;
