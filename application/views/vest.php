...
<html>
<head>
<title>Rattop Bastard| Vest :: w3layouts</title>
		   ...
		   <h2>VEST</h2>
			<?php
		 	...
		 	<div class="bike">				 
		     	...
		     	<div class="bike-cost">
					<div class="bike-mdl">
						<h4><?php echo $row->nama; ?><span>Model:Vest</span></h4>
					</div>
					<!-- <div class="bike-cart">						 
				...
				<div class="fast-viw">
					<form role="form" action="<?php echo base_URL(); ?>index.php/welcome/detail" method="post" id="view<?php echo $row->idvest; ?>">
                    <?php echo form_hidden('id', $row->idvest); ?>
                    <?php echo form_hidden('type','vest'); ?>
                    </form>
                    <button type="submit" form="view<?php echo $row->idvest; ?>" data-html="true">Quick View</button>
				</div>
			</div>
			<?php 
			$counter++;
