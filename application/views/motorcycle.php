...
<html>
<head>
<title>Rattop Bastard| Motorcycle :: w3layouts</title>
	   ...
	   <div class="singlespeed-sec">
		   <h2>MOTORCYCLE</h2>
			...
			<div class="bike2">				 
				 ...
				 <div class="bike-cost2">
					 <div class="bike-mdl2">
						 <h4><?php echo $row->nama; ?></br><span>Model: Motorcycle</span></h4>
					 </div>
					 <div class="clearfix"></div>
				 </div>
				 <div class="fast-viw2">
						<form role="form" action="<?php echo base_URL(); ?>index.php/welcome/detail" method="post" id="view<?php echo $row->idmotorcycle; ?>">
                        <?php echo form_hidden('id', $row->idmotorcycle); ?>
                        <?php echo form_hidden('type','motorcycle'); ?>
                        </form>
                        <button type="submit" form="view<?php echo $row->idmotorcycle; ?>" data-html="true">Quick View</button>
				 </div>
			 </div>
			 <?php 
			$counter++;
