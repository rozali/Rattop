...
<html>
<head>
<title>Rattop Bastard| T-Shirt :: w3layouts</title>
...
<div class="bikes">		 
	 <div class="mountain-sec">
		 ...
		 <div class="bike">				 
		     ...
		     <div class="bike-cost">
					 <div class="bike-mdl">
						 <h4><?php echo $row->nama; ?><span><?php echo $row->model; ?></span></h4>
					 </div>
					 <!-- <div class="bike-cart">						 
						 <button class="buy" href="single.html">BUY NOW</button>
					 </div> -->
					 <div class="clearfix"></div>
				 </div>
				 <div class="fast-viw">
				 		<form role="form" action="<?php echo base_URL(); ?>index.php/welcome/detail" method="post" id="view<?php echo $row->idtshirt; ?>">
                        <?php echo form_hidden('id', $row->idtshirt); ?>
                        <?php echo form_hidden('type','tshirt'); ?>
                        </form>
                        <button type="submit" form="view<?php echo $row->idtshirt; ?>" data-html="true">Quick View</button>
				 </div>
			</div>
			<?php 
			$counter++;
