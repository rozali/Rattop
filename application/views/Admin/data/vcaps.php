                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                    <form role="form" action="<?php echo base_URL(); ?>index.php/welcome/dcaps" method="post" id="delete<?php echo $row->idcaps; ?>">
                                                    <?php echo form_hidden('delete', $row->idcaps); ?>
                                                    </form>
                                                    <form role="form" action="<?php echo base_URL(); ?>index.php/welcome/ucaps" method="post" id="update<?php echo $row->idcaps; ?>">
                                                    ...
                                                    <button type="submit" class="btn btn-outline btn-danger btn-xs" onclick="return confirm('Anda Yakin..?')" form="delete<?php echo $row->idcaps; ?>">Delete</button>
                                                    <button type="submit" class="btn btn-outline btn-success btn-xs" form="update<?php echo $row->idcaps; ?>" data-html="true">Update</button>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
