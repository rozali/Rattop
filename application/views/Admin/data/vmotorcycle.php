...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Motorcycle</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                    <form role="form" action="<?php echo base_URL(); ?>index.php/welcome/dmotorcycle" method="post" id="delete<?php echo $row->idmotorcycle; ?>">
                                                    <?php echo form_hidden('delete', $row->idmotorcycle); ?>
                                                    </form>
                                                    <form role="form" action="<?php echo base_URL(); ?>index.php/welcome/umotorcycle" method="post" id="update<?php echo $row->idmotorcycle; ?>">
                                                    <?php echo form_hidden('id', $row->idmotorcycle); ?>
                                                    </form>
                                                    ...
                                                    <button type="submit" class="btn btn-outline btn-danger btn-xs" onclick="return confirm('Anda Yakin..?')" form="delete<?php echo $row->idmotorcycle; ?>">Delete</button>
                                                    <button type="submit" class="btn btn-outline btn-success btn-xs" form="update<?php echo $row->idmotorcycle; ?>" data-html="true">Update</button>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
