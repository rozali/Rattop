                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                    <form role="form" action="<?php echo base_URL(); ?>index.php/welcome/dvest" method="post" id="delete<?php echo $row->idvest; ?>">
                                                    <?php echo form_hidden('delete', $row->idvest); ?>
                                                    </form>
                                                    <form role="form" action="<?php echo base_URL(); ?>index.php/welcome/uvest" method="post" id="update<?php echo $row->idvest; ?>">
                                                    ...
                                                    <button type="submit" class="btn btn-outline btn-danger btn-xs" onclick="return confirm('Anda Yakin..?')" form="delete<?php echo $row->idvest; ?>">Delete</button>
                                                    <button type="submit" class="btn btn-outline btn-success btn-xs" form="update<?php echo $row->idvest; ?>" data-html="true">Update</button>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
