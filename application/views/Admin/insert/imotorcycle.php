...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Insert Motorcycle</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Insert Form Motorcycle
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="<?php echo base_URL(); ?>index.php/welcome/addmtrc" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label>Input Gambar Motorcycle</label>
                                            <input type="file" name="gambar" required>
                                            <p class="help-block">MAX 10000 x 10000 px</p>
                                        </div>
                                        <div class="form-group">
                                            <label>Nama Motorcycle</label>
                                            <input class="form-control" placeholder="Nama Motorcycle" name="nama">
                                        </div>
                                        <div class="form-group">
