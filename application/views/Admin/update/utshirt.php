                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="alert alert-warning">
                            T-Shirt update are in progress. Back to <a href="<?php echo base_url(); ?>index.php/welcome/vtshirt" class="alert-link">T-Shirt View</a>.
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="<?php echo base_URL(); ?>index.php/welcome/updatetshirt" method="post" accept-charset="utf-8" enctype="multipart/form-data">
