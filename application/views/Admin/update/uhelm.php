                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="alert alert-warning">
                            Helm update are in progress. Back to <a href="<?php echo base_url(); ?>index.php/welcome/vhelm" class="alert-link">Helm View</a>.
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="<?php echo base_URL(); ?>index.php/welcome/updatehelm" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                        ...
                                        <?php echo form_hidden('id', $row->idhelm); ?>
                                        <div class="form-group">
                                            <label>Nama helm</label>
                                            <input class="form-control" value="<?php echo $row->nama; ?>" name="nama">
                                        </div>
                                        <div class="form-group">
                                            <label>Model helm</label>
