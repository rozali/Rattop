...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Update Merchendise</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="alert alert-warning">
                            WorkShirt update are in progress. Back to <a href="<?php echo base_url(); ?>index.php/welcome/vworkshirt" class="alert-link">WorkShirt View</a>.
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="<?php echo base_URL(); ?>index.php/welcome/updateworkshirt" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                        <?php foreach ($data as $row) ?>
                                        <div class="form-group">
                                            <img src='<?php echo base_url();?>images/<?php echo $row->gambar; ?>' width='200'/>
                                        </div>
                                        <div class="form-group">
                                            <input type="file" name="gambar">
                                            <p class="help-block">MAX 10000 x 10000 px</p>
                                        </div>
                                        <?php echo form_hidden('id', $row->idworkshirt); ?>
                                        <div class="form-group">
                                            <label>Nama WorkShirt</label>
                                            <input class="form-control" value="<?php echo $row->nama; ?>" name="nama">
                                        </div>
                                        <div class="form-group">
                                            <label>Model WorkShirt</label>
                                            <input class="form-control" value="<?php echo $row->model; ?>" name="model">
                                        </div>
                                        <div class="form-group">
                                            <label>Warna WorkShirt</label>
                                            <input class="form-control" value="<?php echo $row->warna; ?>" name="warna">
                                        </div>
                                        <div class="form-group">
                                            <label>Bahan WorkShirt</label>
                                            <input class="form-control" value="<?php echo $row->bahan; ?>" name="bahan">
                                        </div>
                                        <div class="form-group">
                                            <label>Harga WorkShirt</label>
                                            <input class="form-control" value="<?php echo $row->harga; ?>" name="harga">
                                        </div>
                                        <div class="form-group">
