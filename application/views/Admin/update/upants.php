                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="alert alert-warning">
                            Pants update are in progress. Back to <a href="<?php echo base_url(); ?>index.php/welcome/vpants" class="alert-link">Pants View</a>.
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="<?php echo base_URL(); ?>index.php/welcome/updatepants" method="post" accept-charset="utf-8" enctype="multipart/form-data">
