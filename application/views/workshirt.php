...
<html>
<head>
<title>Rattop Bastard| Workshirt :: w3layouts</title>
	   ...
	   <div class="singlespeed-sec">
		   <h2>WORKSHIRT</h2>
			...
			<div class="bike">				 
		     	...
		     	<div class="bike-cost">
					<div class="bike-mdl">
						<h4><?php echo $row->nama; ?><span>Model:<?php echo $row->model; ?></span></h4>
					</div>
					<div class="clearfix"></div>
				</div>
				<div class="fast-viw">
					<form role="form" action="<?php echo base_URL(); ?>index.php/welcome/detail" method="post" id="view<?php echo $row->idworkshirt; ?>">
                    <?php echo form_hidden('id', $row->idworkshirt); ?>
                    <?php echo form_hidden('type','workshirt'); ?>
                	</form>
                    <button type="submit" form="view<?php echo $row->idworkshirt; ?>" data-html="true">Quick View</button>
				</div>
			</div></a>
			<?php 
			$counter++;
